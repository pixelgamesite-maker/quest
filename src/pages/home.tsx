    ...
    <MainLayout>
      ...
      <section className="border-b border-white/5 py-24 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="font-serif text-3xl md:text-4xl font-black text-white tracking-widest mb-16">AWAKEN THE ELEMENTS</h2>
        ...
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10">
          <div className="max-w-lg">
            ...
            <p className="text-xs text-zinc-500 leading-relaxed">
              Want WL spots for your community from Earnity? Apply for a collab and connect with our growing Web3 community.
            </p>
          </div>
          <Link href="/collab">
